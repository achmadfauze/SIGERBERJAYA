...
class AllPopularList extends StatelessWidget {
  const AllPopularList({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Tempat Terpopuler"), //title aof appbar
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: Text("${itemsPopular[index]['Desc']}",
                                      maxLines: 1,
...
//       appBar: AppBar(
//         //appbar widget on Scaffold
//         title: Text("Tempat - tempat Populer"), //title aof appbar
