...
class DetailRecomendation extends StatefulWidget {
  const DetailRecomendation({super.key});

  @override
  State<DetailRecomendation> createState() => _DetailTempatState();
}

class _DetailTempatState extends State<DetailRecomendation> {
  int currentPos = 0;
